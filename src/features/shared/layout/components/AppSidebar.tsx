    ...
    <aside className="w-[260px] min-h-screen flex flex-col shrink-0 bg-background/80 backdrop-blur-2xl border-r border-border/50">
      ...
      <div className="p-5 border-b border-border/40 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-primary/20 via-primary/10 to-transparent border border-primary/30 p-1 flex items-center justify-center shadow-lg shadow-primary/20">
            <img src="/smart-meter.png" alt="MeterTrack" className="w-full h-full object-contain" />
          </div>
          <div>
            ...
            <p className="text-[10px] text-muted-foreground font-mono uppercase tracking-widest">GPS Beacon</p>
          </div>
        </div>
        {onClose && (
